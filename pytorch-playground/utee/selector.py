...
def mnas_10(cuda=True, model_root=None):
    print("Building and initializing mnas_10 parameters")
    from imagenet import mnasnet
    #m = inception.inception_v3(True, model_root)
    m = mnasnet.mnasnet1_0(True, model_root)

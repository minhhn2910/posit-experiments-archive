...
if __name__ == '__main__':
    ...
    #original_table = np.array([2.3438E-02, 7.0312E-02, 1.0547E-01, 1.4062E-01, 1.8750E-01, 2.5000E-01, 5.0000E-01, 7.5000E-01])
    ...
    for i in range(24):
        ...
        for i in range(len(current_table)):
            ...
            print (res_remove)
        res_remove = np.array(res_remove)
        remove_idx = np.argsort(0-res_remove)
        remove_idx = list(remove_idx)
        current_table = np.delete(current_table,remove_idx[0])
        print (current_table)
    print ("end -------------------")
    print (current_table)
